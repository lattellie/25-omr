...
if __name__ == '__main__':
    ...
    # BEE6
    dataSeperate = [1,17,31,43,57,83,95,111,124,139,154,166,177,196,209,221,241,260,276,298,317,329,354,368,381,395,407,426,440,452,464,479,493,
    ...
    dataSeperate = addValToList(dataSeperate, 78, 89, 1)
    dataSeperate = addValToList(dataSeperate, 87, 89, 1)
